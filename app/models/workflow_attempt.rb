class WorkflowAttempt < ApplicationRecord
  ...
  has_many :prepared_publication_preflights, class_name: "PublicationPreflight", foreign_key: :prepared_attempt_id,
    inverse_of: :prepared_attempt, dependent: :restrict_with_exception
  has_many :owned_publication_preflights, class_name: "PublicationPreflight", foreign_key: :current_owner_attempt_id,
    inverse_of: :current_owner_attempt, dependent: :restrict_with_exception
